...
exports.pattern = /^\/(?:sticker)(!)?(?:(?:\s+)(.+))?/i;

exports.aliases = ['sticker'];

exports.description = 'Searches Giphy for an animated sticker';

exports.examples = [
'/sticker <b>{search phrase}</b>'
];
...
exports.run = function *() {
  ...
  if (query) {
    var url = 'http://api.giphy.com/v1/stickers/search';
    ...
    if (!message) {
      message = 'Sorry, no stickers matched your search phrase';
    }
